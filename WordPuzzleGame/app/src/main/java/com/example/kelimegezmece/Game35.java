...
public class Game35 extends AppCompatActivity {
    ...
    String isim;
    String textbul;
    String[] harf = {"Ö","Z","G","Ü","R"};
    String[] kutuda;
    ImageView tik;
    int bulunan_1 = 0, bulunan_2 = 0, bulunan_3=0, bulunan_4=0, bulunan_5=0, bulunan_6=0, bulunan_7=0, kelime=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn7.setOnDragListener(dragListener_3);
        ...
        btn18.setOnDragListener(dragListener_11);
        btn19.setOnDragListener(dragListener_12);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent git = new Intent(Game35.this, MainActivity.class);
                startActivity(git);
            }
        });
        ...
        siralama.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent git = new Intent(Game35.this, istatistik.class);
                startActivity(git);
            }
        });
    ...
    public void kontrol() {
        ...
        kutuda[3] = btn7.getText().toString();
        ...
        kutuda[11] = btn18.getText().toString();
        kutuda[12] = btn19.getText().toString();
        ...
        if (bulunan_2 != 1) {
            if (kutuda[2] == harf[0] && kutuda[4] == harf[1] && kutuda[8] == harf[3] && kutuda[12] == harf[4] ) {
                bulunan_2 = 1;
                kelime=kelime+1;
                tik("ÖZÜR");
            }
        ...
        if (bulunan_3 != 1) {
            if (kutuda[1] == harf[2] && kutuda[3] == harf[3] && kutuda[6] == harf[1]) {
                bulunan_3 = 1;
                kelime=kelime+1;
                tik("GÜZ");
            }
            if (kutuda[7] == harf[2] && kutuda[11] == harf[3] && kutuda[13] == harf[1]) {
                bulunan_3 = 1;
                kelime=kelime+1;
                tik("GÜZ");
            }
        ...
        if (bulunan_4 != 1) {
            if (kutuda[1] == harf[2] && kutuda[3] == harf[0] && kutuda[6] == harf[1]) {
                bulunan_4 = 1;
                kelime=kelime+1;
                tik("GÖZ");
            }
            if (kutuda[7] == harf[2] && kutuda[11] == harf[0] && kutuda[13] == harf[1]) {
                bulunan_4 = 1;
                kelime=kelime+1;
                tik("GÖZ");
            }
        ...
        if (bulunan_5 != 1) {
            if (kutuda[5] == harf[0] && kutuda[10] == harf[1]) {
                bulunan_5 = 1;
                kelime=kelime+1;
                tik("ÖZ");
            }
            if (kutuda[5] == harf[0] && kutuda[10] == harf[4]) {
                bulunan_5 = 1;
                kelime=kelime+1;
                tik("ÖR");
            }
        ...
        if (bulunan_6 != 1) {
            if (kutuda[7] == harf[2] && kutuda[11] == harf[3] && kutuda[13] == harf[4]) {
                bulunan_6 = 1;
                kelime=kelime+1;
                tik("GÖR");
            }
    ...
    public void basarili() {
        ...
        Intent intent = new Intent(context, istatistik.class);
