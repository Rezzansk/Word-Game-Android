...
public class Game33 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn8.setOnDragListener(dragListener_4);
        ...
        btn19.setOnDragListener(dragListener_10);

        ////Anasayfaya don
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent git = new Intent(Game33.this, MainActivity.class);
                startActivity(git);
            }
        });
        ...
        siralama.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent git = new Intent(Game33.this, istatistik.class);
                startActivity(git);
            }
        });
    ...
    public void kontrol() {
        ...
        kutuda[10] = btn19.getText().toString();
        ...
        if (bulunan_2 != 1) {
            if (kutuda[1] == harf[0] && kutuda[2] == harf[1] && kutuda[3] == harf[4] ) {
                bulunan_2 = 1;
                tik("SON");
            }
            if (kutuda[1] == harf[0] && kutuda[2] == harf[1] && kutuda[3] == harf[0] ) {
                bulunan_2 = 1;
                tik("SOS");
            }
        }
        if (bulunan_3 != 1) {
            if (kutuda[1] == harf[0] && kutuda[4] == harf[3] && kutuda[7] == harf[2] ) {
                bulunan_3 = 1;
                tik("SAĞ");
            }
        }
        if (bulunan_4 != 1) {
            if (kutuda[8] == harf[3] && kutuda[10] == harf[4]) {
                bulunan_4 = 1;
                tik("AN");
            }
            if (kutuda[8] == harf[3] && kutuda[10] == harf[0]) {
                bulunan_4 = 1;
                tik("AS");
            }
            if (kutuda[8] == harf[3] && kutuda[10] == harf[2]) {
                bulunan_4 = 1;
                tik("AĞ");
            }
        }
    ...
    public void basarili() {
        ...
        Intent intent = new Intent(context, Game34.class);
