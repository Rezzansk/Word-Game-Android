...
public class Game6 extends AppCompatActivity {
    ...
    String[] kutuda;
    ImageView tik;
    int bulunan = 0, bulunan_2 = 0, bulunan_3;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent git = new Intent(Game6.this, MainActivity.class);
                startActivity(git);
            }
        });
        ...
        siralama.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent git = new Intent(Game6.this, istatistik.class);
                startActivity(git);
            }
        });
    ...
    public void kontrol() {
        ...
        kutuda[0] = btn3.getText().toString();
        ...
        if(bulunan_2 != 1)
        {
            if (kutuda[0] == harf[1] && kutuda[3] == harf[2]) {
                bulunan_2 = 1;
                tik("AŞ");
            }
        ...
        if(bulunan_3 != 1)
        {
            if (kutuda[2] == harf[1] && kutuda[4] == harf[0]) {
                bulunan_3 = 1;
                tik("AY");
            }
        }
    ...
    public void basarili() {
        ...
        Intent intent = new Intent(context, Game21.class);
