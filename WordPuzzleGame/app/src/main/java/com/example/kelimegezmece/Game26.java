...
public class Game26 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn9.setOnDragListener(dragListener_7);
        btn10.setOnDragListener(dragListener_8);
        btn12.setOnDragListener(dragListener_9);
        btn14.setOnDragListener(dragListener_10);

        ////Anasayfaya don
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent git = new Intent(Game26.this, MainActivity.class);
                startActivity(git);
            }
        });
        ...
        siralama.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent git = new Intent(Game26.this, istatistik.class);
                startActivity(git);
            }
        });
    ...
    public void kontrol() {
        ...
        kutuda[6] = btn9.getText().toString();
        kutuda[7] = btn10.getText().toString();
        kutuda[8] = btn12.getText().toString();
        ...
        if(bulunan_2 != 1)
        {
            if (kutuda[0] == harf[3] && kutuda[2] == harf[0] && kutuda[6] == harf[3]) {
                bulunan_2 = 1;
                tik("AMA");
            }
        }
        if(bulunan_3 != 1)
        {
            if (kutuda[3] == harf[1] && kutuda[7] == harf[2] && kutuda[9] == harf[3]) {
                bulunan_3 = 1;
                tik("ODA");
            }
        }
        if(bulunan_4 != 1)
        {
            if (kutuda[1] == harf[2] && kutuda[5] == harf[3] && kutuda[8] == harf[0]) {
                bulunan_4 = 1;
                tik("DAM");
            }
        }
        if(bulunan_5 != 1)
        {
            if (kutuda[6] == harf[3] && kutuda[7] == harf[2]) {
                bulunan_5 = 1;
                tik("AD");
            }
        }
    ...
    public void basarili() {
        ...
        Intent intent = new Intent(context, Game31.class);
