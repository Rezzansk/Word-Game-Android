...
public class Game2 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn9.setOnDragListener(dragListener_5);

        ////Anasayfaya don
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent git = new Intent(Game2.this, MainActivity.class);
                startActivity(git);
            }
        });
        ...
        siralama.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent git = new Intent(Game2.this, istatistik.class);
                startActivity(git);
            }
        });
    ...
    public void kontrol() {
        ...
        if(bulunan != 1)
        {
            if (kutuda[0] == harf[0] && kutuda[1] == harf[1] && kutuda[2] == harf[2]) {
                bulunan = 1;
                tik("TUŞ");
            }
            if (kutuda[2] == harf[0] && kutuda[3] == harf[1] && kutuda[4] == harf[2]) {
                bulunan = 1;
                tik("TUŞ");
            }
        }
        if(bulunan_2 != 1)
        {
            if (kutuda[2] == harf[2] && kutuda[3] == harf[1] && kutuda[4] == harf[0]) {
                bulunan_2 = 1;
                tik("ŞUT");
            }
            if (kutuda[0] == harf[2] && kutuda[1] == harf[1] && kutuda[2] == harf[0]) {
                bulunan_2 = 1;
                tik("ŞUT");
            }
        }
