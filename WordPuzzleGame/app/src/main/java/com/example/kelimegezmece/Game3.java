...
public class Game3 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent git = new Intent(Game3.this, MainActivity.class);
                startActivity(git);
            }
        });
        ...
        siralama.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent git = new Intent(Game3.this, istatistik.class);
                startActivity(git);
            }
        });
    ...
    public void kontrol() {
        ...
        if(bulunan != 1)
        {
            ...
            if (kutuda[0] == harf[0] && kutuda[1] == harf[1] && kutuda[2] == harf[0]) {
                bulunan = 1;
                tik("SÜS");
            }
        }
        if(bulunan_2 != 1)
        {
            if (kutuda[0] == harf[0] && kutuda[3] == harf[1] && kutuda[4] == harf[2]) {
                bulunan_2 = 1;
                tik("SÜR");
            }
            if (kutuda[0] == harf[0] && kutuda[3] == harf[1] && kutuda[4] == harf[0]) {
                bulunan_2 = 1;
                tik("SÜS");
            }
        }
