...
public class Game5 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent git = new Intent(Game5.this, MainActivity.class);
                startActivity(git);
            }
        });
        ...
        siralama.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent git = new Intent(Game5.this, istatistik.class);
                startActivity(git);
            }
        });
    ...
    public void basarili() {
        ...
        Intent intent = new Intent(context, Game6.class);
