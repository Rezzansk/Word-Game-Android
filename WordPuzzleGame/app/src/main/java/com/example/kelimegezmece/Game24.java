...
public class Game24 extends AppCompatActivity {
    ...
    String[] kutuda;
    ImageView tik;
    int bulunan_1 = 0, bulunan_2 = 0, bulunan_3=0, bulunan_4=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn16.setOnDragListener(dragListener_9);

        ////Anasayfaya don
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent git = new Intent(Game24.this, MainActivity.class);
                startActivity(git);
            }
        });
        ...
        siralama.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent git = new Intent(Game24.this, istatistik.class);
                startActivity(git);
            }
        });
    ...
    public void kontrol() {
        ...
        kutuda[1] = btn5.getText().toString();
        ...
        kutuda[7] = btn14.getText().toString();
        kutuda[8] = btn16.getText().toString();

        if(bulunan_1 != 1)
        {
            if (kutuda[3] == harf[0] && kutuda[4] == harf[1] && kutuda[5] == harf[2] && kutuda[6] == harf[3]) {
                bulunan_1 = 1;
                tik("KOŞU");
            }
        }
        if(bulunan_2 != 1)
        {
            if (kutuda[0] == harf[2] && kutuda[1] == harf[1] && kutuda[3] == harf[0]) {
                bulunan_2 = 1;
                tik("ŞOK");
            }
        }
        if(bulunan_3 != 1)
        {
            if (kutuda[2] == harf[0] && kutuda[6] == harf[3] && kutuda[8] == harf[2]) {
                bulunan_3 = 1;
                tik("KUŞ");
            }
        }
        if(bulunan_4 != 1)
        {
            if (kutuda[4] == harf[1] && kutuda[7] == harf[0]) {
                bulunan_4 = 1;
                tik("OK");
            }
        }
    ...
    public void basarili() {
        ...
        Intent intent = new Intent(context, Game25.class);
