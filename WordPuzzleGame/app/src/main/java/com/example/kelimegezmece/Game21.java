...
public class Game21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn7.setOnDragListener(dragListener_4);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent git = new Intent(Game21.this, MainActivity.class);
                startActivity(git);
            }
        });
        ...
        siralama.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent git = new Intent(Game21.this, istatistik.class);
                startActivity(git);
            }
        });
    ...
    public void kontrol() {
        ...
        kutuda[2] = btn6.getText().toString();
        ...
        if(bulunan != 1)
        {
            if (kutuda[1] == harf[0] && kutuda[2] == harf[1] && kutuda[3] == harf[2] && kutuda[4] == harf[3]) {
                bulunan = 1;
                tik("ÜMİT");
            }
        }
        if(bulunan_2 != 1)
        {
            if (kutuda[0] == harf[3] && kutuda[1] == harf[0] && kutuda[5] == harf[1]) {
                bulunan_2 = 1;
                tik("TÜM");
            }
        }
    ...
    public void basarili() {
        ...
        Intent intent = new Intent(context, Game22.class);
