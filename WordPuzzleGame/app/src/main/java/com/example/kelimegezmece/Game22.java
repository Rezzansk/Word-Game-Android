...
public class Game22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn10.setOnDragListener(dragListener_6);
        btn11.setOnDragListener(dragListener_7);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent git = new Intent(Game22.this, MainActivity.class);
                startActivity(git);
            }
        });
        ...
        siralama.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent git = new Intent(Game22.this, istatistik.class);
                startActivity(git);
            }
        });
    ...
    public void kontrol() {
        ...
        if(bulunan_2 != 1)
        {
            if (kutuda[3] == harf[3] && kutuda[4] == harf[1] && kutuda[7] == harf[2]) {
                bulunan_2 = 1;
                tik("ÇİN");
            }
        }
        if(bulunan_3 != 1)
        {
            if (kutuda[5] == harf[0] && kutuda[6] == harf[1] && kutuda[7] == harf[2]) {
                bulunan_3 = 1;
                tik("DİN");
            }
        }
    ...
    public void basarili() {
        ...
        Intent intent = new Intent(context, Game23.class);
